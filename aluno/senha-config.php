<?php
    ...
    if(isset($_POST['btn-repor'])){
        ...
        if(empty($email)){
            ...
            $_SESSION['message'] = "<h5 class='alert alert-danger'>PORFAVOR! Digite O Seu E-mail!</h5> ";
...
<head>
    ...
    <title>Repor Senha | Conta IPTEL</title>
...
<body style="background-color:rgb(3, 60, 117);">
    <div class="container" style=" background-color: #fff;">
        ...
        <form  method="POST">
            <p id="msg-receber">Vai Recerber um Código no E-mail</p>
        ...
        ?>
            ...
            <div class="mb-3" id="button">
                <button type="submit" style="width: 300px;" class="btn-repor" name="btn-repor"><i style="color:#Fff;" class="fa-solid fa-right-to-bracket"></i> Enviar Código</button>
            </div>
        </form>
    </div>
</body>
